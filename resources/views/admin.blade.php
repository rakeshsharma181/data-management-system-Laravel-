  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Welcome{{session('id')}}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if(session('role')=='Sales' || session('role')=='Superadmin')
          ...
          <li class="nav-item menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="create_category" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>create Category</p>
                </a>
              </li>
...
<li class="nav-item menu-close">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="create_product" class="nav-link active">
        <i class="far fa-circle nav-icon"></i>
        <p>create Product</p>
      </a>
    </li>
